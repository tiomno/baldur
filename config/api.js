...
exports['default'] = {
    general: function(api) {
        ...
        return {
            ...
            serverToken: 'AH-CLOUD-API',
            // The welcome message seen by TCP and webSocket clients upon connection
            welcomeMessage: 'Hello! Welcome to Baldur - connecDIMCloud API',
            // the redis prefix for actionhero's cache objects
            cachePrefix: 'baldur:cache:',
            // the redis prefix for actionhero's cache/lock objects
            lockPrefix: 'baldur:lock:',
            ...
            // disables the white listing of client params
            disableParamScrubbing: false,
            // params you would like hidden from any logs
            filteredParams: [],
            // values that signify missing params
            missingParamChecks: [null, '', undefined],
            // The default file type to server when a user requests a directory
